...
global $wpdb;
$carro=$wpdb->get_results("select count(*) as cuantos from {$wpdb->prefix}tamila_tienda_carro_detalle 
...
<nav class="navbar navbar-expand-lg bg-dark navbar-light d-none d-lg-block" id="templatemo_nav_top">
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:info@company.com">info@tutienda.com</a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <img class="logo-tienda" src="<?php echo get_template_directory_uri() ?>/assets/img/logo.png" title="<?php bloginfo('name'); ?>" alt="<?php bloginfo('name'); ?>" />
            </a>
