            ...
            <div class="row text-light mb-4">
                ...
                <div class="col-auto">
                    ...
                    <div class="input-group mb-2">
                       <img src="<?php echo get_site_url()."/wp-content/themes/theme_ITC/assets/images/4pasarelacontorno.png"?>" alt="" height="100" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <p class="text-left text-light">
                            ...
                            | Desarrollado por <a rel="sponsored" href="https://www.cesarcancino.com" target="_blank" title="Liff Domotic">LiffDomotic</a>
                        </p>
                    </div>
                </div>
            </div>
