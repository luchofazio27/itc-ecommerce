...
//crear páginas
if(!function_exists('itc_tienda_crear_paginas')){
    function itc_tienda_crear_paginas(){
        ...
        if(!isset($page1)){
            $activated=[
                ...
                <div class="row py-5">[itc_tienda_activated id=1]</div>
                </div>',
                'post_status'   => 'publish',
                'post_author'   => 1
                ];
        ...
        if(!isset($page2)){
          $restablecer = array(
            ...
            'post_content'  => '<div class="container py-5">
            <div class="row py-5">[itc_tienda_restablecer id=1]</div>
            </div>',
            'post_status'   => 'publish',
            'post_author'   => 1
          );
        ...
        if(!isset($page3)){
          $reset = array(
            ...
            'post_title'    => 'Reset',
            'post_content'  => '<div class="container py-5">
            <div class="row py-5">[itc_tienda_reset id=1]</div>
            </div>',
            'post_status'   => 'publish',
            'post_author'   => 1
          );
        ...
        if(!isset($page4)){
          $login = array(
            ...
            'post_title'    => 'Login',
            'post_content'  => '<div class="container py-5">
            <div class="row py-5">[itc_tienda_login id=1]</div>
            </div>',
            'post_status'   => 'publish',
            'post_author'   => 1
          );
          ...
          if(!isset($page5)){
            $registro = array(
              ...
              'post_title'    => 'Registro',
              'post_content'  => '<div class="container py-5">
              <div class="row py-5">[itc_tienda_registro id=1]</div>
              </div>',
              'post_status'   => 'publish',
              'post_author'   => 1
            );
          ...
          $page6=get_page_by_path( 'perfil' , OBJECT );  
            if(!isset($page6)){
              $perfil = array(
                ...
                'post_title'    => 'Perfil',
                'post_content'  => '<div class="container py-5">
                <div class="row py-5">[itc_tienda_perfil id=1]</div>
                </div>',
                'post_status'   => 'publish',
                'post_author'   => 1
              );
          ...
          $page7=get_page_by_path( 'checkout' , OBJECT );  
              if(!isset($page7)){
                $checkout = array(
                  ...
                  'post_title'    => 'Checkout',
                  'post_content'  => '<div class="container py-5">
                  <div class="row py-5">[itc_tienda_checkout id=1]</div>
                  </div>',
                  'post_status'   => 'publish',
                  'post_author'   => 1
                );
        ...
        $page8=get_page_by_path( 'verificacion' , OBJECT );  
                if(!isset($page8)){
                  $verificacion = array(
                    ...
                    'post_content'  => '<div class="container py-5">
                    <div class="row py-5">[itc_tienda_verificacion id=1]</div>
                    </div>',
                    'post_status'   => 'publish',
                    'post_author'   => 1
                  );
...
if(!function_exists('itc_tienda_eliminar_paginas')){
    function itc_tienda_eliminar_paginas(){
