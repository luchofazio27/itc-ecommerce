...
if(isset($_POST['nonce'])){
    switch($_POST['accion']){
        ...
        break;
        case '3':
            $wpdb->delete($tabla2, array('itc_contact_id' =>$_POST['id']));
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">[itc_contact id=<?php echo $dato->id;?>]</td>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            <form action="" method="POST" name="itc_contact_form_crear">
                <div class="mb-3">
                    <label for="nombre" class="form-label">Nombre:</label>
                    <input type="text" name="nombre" id="itc_contact_nombre" class="form-control" placeholder="Nombre" /> 
                </div>
                <div class="mb-3">
                    <label for="correo" class="form-label">E-Mail:</label>
                    <input type="text" name="correo" id="itc_contact_correo" class="form-control" placeholder="E-Mail" /> 
                </div>
                <hr/>
                <input type="hidden" name="nonce" value="<?php echo wp_create_nonce('seg');?>" />
                <input type="hidden" name="id" id="itc_contact_id" />
                <input type="hidden" name="accion" id="itc_contact_accion" />
                <a href="javascript:void(0);" title="Enviar" class="btn btn-warning" onclick="itc_contact();"><i class="fas fa-plus"></i> Enviar</a>
            </form>
        </div>
      </div>
    </div>
...
<!--/respuestas-->
<!--eliminar-->
<form action="" name="itc_contact_form_eliminar" method="POST">
<input type="hidden" name="nonce" value="<?php echo wp_create_nonce('seg');?>" id="nonce" />
<input type="hidden" name="accion" id="itc_contact_form_eliminar_que" />
    <input type="hidden" name="id" id="itc_contact_form_eliminar_id" />
</form>
<!--//eliminar-->